...
Conceptual/application artifact. Not a theorem-proof repository.
...
`ncr-new-computational-regime` is infrastructure/documentation, not a theorem-proof repository.
